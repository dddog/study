...
/*
 * A controller class, generate dummy data for demonstration, 
 * and get the request parameter to determine which view to return. 
 * If the request parameter is equal to “PDF“, then return an Pdf view 
 */
