package com.jacademy.y05mybatis.service.impl;
...
import com.jacademy.y05mybatis.service.HeroService;
...
public class HeroServiceImplTest {
	...
	public void testSearch() {
		...
		List<Hero> list = service.search(hero);
		for (Hero h : list) {
			System.out.println(h.getSno()+","+h.getName()+","+h.getAge());
		}
